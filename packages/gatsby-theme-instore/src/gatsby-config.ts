...
module.exports = ({
  ...
  assert(
    tenant,
    `Tenant not found in gatsby-theme-instore. Do you have a vtex.env configuration file ?`
  )
  assert(
    environment,
    `Environment not found in gatsby-theme-instore. Do you have a vtex.env configuration file ?`
  )
  assert(
    workspace,
    `Workspace not found in gatsby-theme-instore. Do you have a vtex.env configuration file ?`
  )
